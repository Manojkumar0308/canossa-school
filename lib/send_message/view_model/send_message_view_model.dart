  ...
  Future<void> pickImageAndSetContent(BuildContext context) async {
    ...
    if (result != null) {
      ...
      if (file.extension == 'jpg' ||
        ...
        // Fluttertoast.showToast(msg: 'pdf file picked');
        filename = file.name;
...
It updates the _registrationWise property and turns off other modes.
 After setting the mode, it notifies listeners.*/
  ...
  Future<void> sendNotificationToAll(
    ...
    final pref = await SharedPreferences.getInstance();
    final baseurl = pref.getString('apiurl');
    String url = '$baseurl${hostService.sendtoAll}';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print('sendToAllData response is $sendToAllData');
  ...
  Future<void> multipleClassApi(
    ...
    final pref = await SharedPreferences.getInstance();
    final baseurl = pref.getString('apiurl');
    final url = Uri.parse('$baseurl${hostService.multipleClass}');
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print('multiclassData response is $multiclassData');
  ...
  Future<void> classWiseApi(
    ...
    final pref = await SharedPreferences.getInstance();
    final baseurl = pref.getString('apiurl');
    final url = Uri.parse('$baseurl${hostService.classWise}');
  ...
  Future<void> registrationNoWiseApi(
    ...
    // final url =
    //     Uri.parse('http://expo.citronsoftwares.com${hostService.regnWise}');
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print('regWiseData is $regWiseData');
