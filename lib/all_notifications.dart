...
for the selected student; otherwise, it retrieves notifications for the student
  ...
  */
  Future<void> _loadNotifications() async {
    ...
    final notifications =
        await _databaseHelper.getNotificationsAll(
            ...
            builder: (context,snapshot){
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                if (notifications.isEmpty) {
                  return const Center(
                    child: Text('No elements in the notifications list'),
                  ); // Show a message when the notifications list is empty
                }
