...
class RegisterApi {
  ...
  Future<void> otpVerification(String userName, String mobno, String passwd,
      String email, String otp, String userType, BuildContext context) async {
    final pref = await SharedPreferences.getInstance();
    final baseurl = pref.getString('apiurl');
    try {
      final Map<String, dynamic> requestBody = {
